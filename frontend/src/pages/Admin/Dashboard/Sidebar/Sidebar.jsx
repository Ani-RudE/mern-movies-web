     ...
     return (
          <div className="-translate-y-10 flex h-screen fixed mt-10 border-r-2 border-[#242424]">
               <aside className="text-white w-64 flex-shrink-0">
                    <ul className="py-4">
                         <li className="text-lg  bg-gradient-to-b from-green-500 to-green-400 rounded-full -translate-x-6">
                              <Link
                         ...
                         <li className="text-lg -translate-x-6 hover:bg-green-500 rounded-full">
